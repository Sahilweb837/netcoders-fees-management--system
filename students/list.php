...
if (isset($_GET['branch_filter']) && !empty($_GET['branch_filter'])) {
    $b_id = (int)$_GET['branch_filter'];
    $where .= " AND s.branch_id = $b_id";
}
...
$branches = $conn->query("SELECT * FROM branches"); // Assuming branches table exists, or I can use a static list for now.
            ...
            <div class="card-body">
                <form action="list.php" method="GET">
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-dark btn-block"><i class="fas fa-filter"></i> Filter</button>
                        </div>
                    </div>
                </form>
            </div>
